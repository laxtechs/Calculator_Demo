...
button_substract = tk.Button(master=frame, text="-", padx=15, pady=5, width=3, command=lambda:myClick("-"))
button_substract.grid(row=3, column=3, pady=2)
...
button_division = tk.Button(master=frame, text="/", padx=15, pady=5, width=3, command=lambda:myClick("/"))
button_division.grid(row=4, column=1, pady=2)

button_clear = tk.Button(master=frame, text="clear", padx=15, pady=5, width=3, command=lambda:myClick(0))
button_clear.grid(row=4, column=2, columnspan=1,  pady=2)

button_equal = tk.Button(master=frame, text="=", padx=15, pady=5, width=3, command=lambda:myClick(0))
button_equal.grid(row=4, column=3, columnspan=3, pady=2)
